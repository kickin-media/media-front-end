...
import { combineLatest, filter, first, Observable, shareReplay, startWith, switchMap, tap } from 'rxjs';
...
export class UploadDialogComponent {
  ...
  protected hadUploadErrors = false;
  ...
  onSubmit() {
    ...
    this.status = this.authorService
      .updateAuthor({
