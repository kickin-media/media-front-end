...
import {Configuration} from "../shared/back-end";
...
export const createAngularConfig: (config: Config<any>) => ApplicationConfig = (config) => ({
  providers: [
    ...
    // Provide configuration to the autogenerated API client (by openapi-generator-cli)
    {
      provide: Configuration,
      useValue: new Configuration({
        // Our own HTTPClient interceptor already handles API path prefixing (and authentication),
        // so an empty path will work just fine...
        basePath: "",
      }),
    },
  ],
